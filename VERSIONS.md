...
**Changes:**
- Enable MatchZy ready/unready clan tags in all six mode configs. CSC match JSON omits team tags, so live match clan tags remain blank.
- MatchZy csc.3 packages the same enabled default and includes the csc.2 removeplayer fix.
